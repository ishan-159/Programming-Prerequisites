import java.util.*;
class SchoolStudentResultWith2DArray {
...
//Creating an arrays to store marks, percentages, and grades of the students
...
(percentage[index - 1] >= 40 && percentage[index - 1] <= 49)
grade[index - 1] = "E";
}
else if{
(percentage[index - 1] >= 50 && percentage[index - 1] <= 59)
grade[index - 1] = "D";
}
else if{
(percentage[index - 1] >= 60 && percentage[index - 1] <= 69)
grade[index - 1] = "C";
}
else if{
(percentage[index - 1] >= 70 && percentage[index - 1] <= 79)
grade[index - 1] = "B";
}
else{
grade[index - 1] = "A";
...
// printing the marks percentage and grade
for (int i = 0; i < numberOfStudents; i++) {
System.out.println("The marks of Student " + i + " is in physics : " + marks[i][0] + ", in chemistry : " + marks[i][1] + " and in maths : " + marks[i][2] + ", percentage of student is : " + percentage[i] + "%, and Grade of student is : " + grade[i]);
}
