...
(percentage[index - 1] >= 40 && percentage[index - 1] <= 49) grade[index - 1] = "E";
{
else if{
(percentage[index - 1] >= 50 && percentage[index - 1] <= 59) grade[index - 1] = "D";
}
else if{
(percentage[index - 1] >= 60 && percentage[index - 1] <= 69) grade[index - 1] = "C";
}
else if{
(percentage[index - 1] >= 70 && percentage[index - 1] <= 79) grade[index - 1] = "B";
}
else{ 
grade[index - 1] = "A";
}
