...
// Use a try-catch block to handle the exception when calling generateException directly
try {
System.out.println("Calling method to generate exception...");
generateException(input);
} catch (NumberFormatException e) {
System.out.println("Caught NumberFormatException in main: Invalid input, could not convert to a number.");
}
